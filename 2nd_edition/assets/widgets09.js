...
function initW_planecut(root, D) {
  ...
  function 그리기(깊이) {
    ...
    info.textContent = '질문 ' + 깊이 + '개까지 · 칸 ' + 칸.length + '개'
      + (깊이 === 3 ? ' (교재의 앱이 정해 둔 값)' : '')
      + (채점보임 && acc != null ? ' · 채점용 영화 ' + (P.tpts || []).length + '편으로 잰 정확도 ' + acc.toFixed(3) : '');
