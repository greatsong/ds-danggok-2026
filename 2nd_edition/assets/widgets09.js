...
function initW_labelcurve(root, D) {
  ...
  const WIDGET_INIT = {sigmoidPath: initW_sigmoidPath, splitpick: initW_splitpick, twoDials: initW_twoDials, labelline: initW_labelline, labelcurve: initW_labelcurve};
